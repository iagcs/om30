...
<div class="container">
    ...
    <div class="main">
        <h2>Importação de Arquivo Falhou</h2>
        <p>Olá, {{ $userName }}!</p>
        <p>A importacao do arquivo que você tentou importar falhou. Por favor, revise os dados do seu arquivo e tente novamente.</p>
