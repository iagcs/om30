...
<div class="container">
    ...
    <div class="main">
        <h2>Validação de Arquivo Falhou</h2>
        <p>Olá, {{ $userName }}!</p>
        <p>A validação do arquivo que você tentou importar falhou. Por favor, revise os dados do seu arquivo e tente novamente.</p>
